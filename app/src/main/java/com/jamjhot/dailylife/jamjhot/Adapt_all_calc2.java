 ...
 */
public class Adapt_all_calc2 extends ArrayAdapter<String> {
    ...
    public Adapt_all_calc2(Context context, LinkedList<String> gojol_n_st, String[] bla) {
        super(context, R.layout.adapt_all_calc2, bla);
        this.c = context;
        //this.no= no;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView== null)
        {
            ...
            convertView=inflater.inflate(R.layout.adapt_all_calc2,null);
        }
...
//        holder.rightLogo= (ImageView) convertView.findViewById(R.id.rightLogo);
       ...
       // holder.tvNo.setText(no[position]);
        ...
        if (position==0 || position==2 || position==4 || position==9 || position==11){
            ...
            holder.carrier.setBackgroundResource(R.drawable.btncolor_8);
